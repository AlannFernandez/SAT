    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-green-50 to-white">
      ...
      <header className="w-full flex items-center justify-between px-6 py-4 bg-white/80 shadow-sm sticky top-0 z-10">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-xl text-green-900 tracking-tight">SAT: Sistema de Alerta Temprana</span>
        </div>
        <Link href="/register" className="bg-[#73BD4D] hover:bg-[#5BA83A] text-white font-semibold px-6 py-2 rounded-lg shadow transition">Acceder</Link>
      </header>
      ...
      <section className="flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto px-6 py-16 gap-10">
        <div className="flex-1 text-center md:text-left">
          <h1 className="text-5xl font-extrabold text-green-900 mb-6 leading-tight">
            ...
            <span className="text-[#73BD4D] block mt-2 text-3xl">
          ...
          <Link href="/register" className="inline-block bg-[#73BD4D] hover:bg-[#5BA83A] text-white font-semibold py-4 px-10 rounded-lg shadow-lg text-lg transition">Crear cuenta ahora</Link>
        </div>
      </section>

      {/* Beneficios */}
      <section className="bg-green-100/40 py-12">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-green-900 mb-8 text-center">Beneficios para Técnicos</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
              <svg className="w-10 h-10 text-[#73BD4D] mb-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                <path d="M1 12h22M12 1v22" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              <h3 className="font-semibold text-green-800 mb-2">Funciona sin conexión</h3>
            ...
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
              <svg className="w-10 h-10 text-[#73BD4D] mb-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 8v4l3 3" strokeLinecap="round" strokeLinejoin="round"/></svg>
              <h3 className="font-semibold text-green-800 mb-2">Ahorro de tiempo</h3>
              <p className="text-gray-600 text-sm text-center">Digitalizá recorridas y reportes, evitando papeles y planillas manuales.</p>
            </div>
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
              <svg className="w-10 h-10 text-[#73BD4D] mb-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M5 13l4 4L19 7" strokeLinecap="round" strokeLinejoin="round"/></svg>
              <h3 className="font-semibold text-green-800 mb-2">Informes firmados</h3>
            ...
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
              <svg className="w-10 h-10 text-[#73BD4D] mb-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 20h9"/><path d="M12 4v16m0 0H3" strokeLinecap="round" strokeLinejoin="round"/></svg>
              <h3 className="font-semibold text-green-800 mb-2">Historial y seguimiento</h3>
      ...
      <section className="py-16 max-w-6xl mx-auto px-6">
        <h2 className="text-3xl font-bold text-green-900 mb-10 text-center">Características destacadas</h2>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="flex flex-col items-center bg-white rounded-lg shadow p-6">
            <span className="font-semibold text-green-800 mb-3 text-lg">RGRL</span>
            <p className="text-gray-600 text-sm text-center">Relevamiento General de Riesgos Laborales digital y ágil.</p>
          </div>
          <div className="flex flex-col items-center bg-white rounded-lg shadow p-6">
            <span className="font-semibold text-green-800 mb-3 text-lg">Control de extintores</span>
            <p className="text-gray-600 text-sm text-center">Registra y controla el estado de extintores en cada visita.</p>
          </div>
          <div className="flex flex-col items-center bg-white rounded-lg shadow p-6">
            <span className="font-semibold text-green-800 mb-3 text-lg">Firmas desde la app</span>
            <p className="text-gray-600 text-sm text-center">Firma digital desde el móvil en segundos, sin impresiones.</p>
          </div>
          <div className="flex flex-col items-center bg-white rounded-lg shadow p-6">
            <span className="font-semibold text-green-800 mb-3 text-lg">Visitas de revisión</span>
      ...
      <section className="bg-green-50 py-16">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-green-900 mb-10 text-center">Testimonios</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow p-6 flex flex-col">
              ...
              <div className="flex items-center gap-3 mt-auto">
                <span className="font-semibold text-green-800">María G., Técnica S&H</span>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow p-6 flex flex-col">
              ...
              <div className="flex items-center gap-3 mt-auto">
                <span className="font-semibold text-green-800">Lucas P., Técnico S&H</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 max-w-4xl mx-auto px-6">
        <h2 className="text-3xl font-bold text-green-900 mb-10 text-center">Preguntas frecuentes</h2>
        <div className="space-y-6">
          <details className="bg-white rounded-lg shadow p-4 group">
            <summary className="font-semibold text-green-800 cursor-pointer group-open:text-green-900 flex items-center justify-between gap-2 px-2 py-3 focus:outline-none min-h-[56px]">
              ¿Funciona sin conexión a internet?
              <span className="transition-transform duration-300 group-open:rotate-90">
                <svg className="w-5 h-5 text-[#73BD4D]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* Footer */}
      <footer className="w-full bg-[#73BD4D] text-white py-8 mt-8">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2 mb-4 md:mb-0">
            <span className="font-bold text-lg tracking-tight"></span>
          </div>
          <nav className="flex gap-6 text-sm">
            <Link href="/register" className="px-4 py-2 rounded-lg bg-white/90 text-[#73BD4D] font-semibold shadow hover:bg-white hover:text-[#5BA83A] transition border border-[#73BD4D]">Registrarse</Link>
            <Link href="/login" className="px-4 py-2 rounded-lg bg-[#73BD4D] text-white font-semibold shadow hover:bg-[#8BC962] transition border border-white">Login</Link>
          </nav>
        ...
        <div className="text-center text-xs text-green-200 mt-6">
          ...
          Propiedad de <a href="https://www.soft3ch.com/" target="_blank" rel="noopener noreferrer" className="underline hover:text-green-300">soft3ch.com</a>
        </div>
      </footer>
    </div>
  );
