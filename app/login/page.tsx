            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  required 
                  className="w-full border border-black/20 rounded-lg px-3 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-[#883feb] bg-slate-50" 
                  value={password} 
                ...
                >
                  {showPassword ? (
                    <svg className="h-5 w-5 text-[#883feb] hover:text-[#b47cff]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
